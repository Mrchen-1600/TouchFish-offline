...
1. 点击 **【触发动作】** 选项卡。
2. **安全应用**：选择一个正经的工作软件（如 Word, Excel, 代码编辑器）。
   * *效果*：警报触发时，该软件会自动弹窗遮挡屏幕。
3. **窗口处理**：可选择 **“最小化所有 (Win+D)”** 或 **“关闭当前（Alt + F4）”** 。
...
* **陌生人触发阈值**：默认为 1。数值越大，防误触能力越强（反应稍慢）；数值越小，反应越快。
