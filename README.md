...
<video width="640" height="360" controls autoplay loop muted>
  <source src="https://github.com/mrchen-1600/TouchFish-offline/raw/main/img/sound.mp4" type="video/mp4">
...
1. 在 [Releases](https://github.com/Mrchen-1600/TouchFish-offline/releases "Mrchen-1600") 页面下载最新的压缩包 `TouchFish_v1.0.0.zip`(当前仅支持 windows 系统)。
